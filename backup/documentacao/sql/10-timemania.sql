CREATE TABLE ConcursoTimemania (
    id INT PRIMARY KEY,
	concurso INT,
	data DATE,
	local VARCHAR(255),
...
CREATE TABLE ConcursoTimemania_DezenasOrdemSorteio (
    id INT PRIMARY KEY,
    concursoid INT,
	posicao INT,
    dezenas INT,
    FOREIGN KEY (concursoid) REFERENCES ConcursoTimemania (id)
);

CREATE TABLE ConcursoTimemania_Dezenas (
    id INT PRIMARY KEY,
    concursoid INT,
    dezenas INT,
    FOREIGN KEY (concursoid) REFERENCES ConcursoTimemania (id)
...
CREATE TABLE ConcursoTimemania_Premiacoes (
    id INT PRIMARY KEY,
    concursoid INT,
    premiacoesid INT,
    FOREIGN KEY (concursoid) REFERENCES ConcursoTimemania (id),
...
CREATE TABLE ConcursoTimemania_EstadosPremiados (
    id INT PRIMARY KEY,
    concursoid INT,
	estadosid INT,
	FOREIGN KEY (concursoid) REFERENCES ConcursoTimemania (id),
...
CREATE TABLE ConcursoTimemania_LocalGanhadores (
    id INT PRIMARY KEY,
    concursoid INT,
	localid INT,
	FOREIGN KEY (concursoid) REFERENCES ConcursoTimemania (id),
